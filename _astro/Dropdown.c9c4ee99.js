import{g as m,i as M,t as g,d as oe,a as W,r as le}from"./web.129196f5.js";import{H as ie,C as G}from"./index.60b103fc.js";import{m as N,c as v,a as $,o as O,b as R,d as se,g as ce,e as ue,s as pe,f as r,S as F,F as q,h as de,u as me,i as ge}from"./solid.22849591.js";import{s as k,A as b}from"./Theme.ad91f57f.js";import{B as he}from"./index.5a6d7a6c.js";import{R as fe}from"./index.8faf4249.js";const be=e=>{const t=N({multiple:!1,disabled:!1,optionToValue:s=>s,isOptionDisabled:s=>!1},e),n=s=>{if(t.multiple&&Array.isArray(s))return s;if(!t.multiple&&!Array.isArray(s))return s!==null?[s]:[];throw new Error(`Incompatible value type for ${t.multiple?"multple":"single"} select.`)},[o,a]=v(t.initialValue!==void 0?n(t.initialValue):[]),i=()=>t.multiple?o():o()[0]||null,c=s=>a(n(s)),p=()=>a([]),l=()=>!!(t.multiple?i().length:i());$(O(o,()=>t.onChange?.(i()),{defer:!0}));const[u,d]=v(""),f=()=>d(""),D=()=>!!u().length;$(O(u,s=>t.onInput?.(s),{defer:!0})),$(O(u,s=>{s&&!x()&&y(!0)},{defer:!0}));const w=typeof t.options=="function"?R(()=>t.options(u()),t.options(u())):()=>t.options,z=()=>w().length,S=s=>{if(t.isOptionDisabled(s))return;const _=t.optionToValue(s);t.multiple?c([...o(),_]):(c(_),E(!1)),y(!1)},[J,E]=v(!1),[x,y]=v(!1),B=()=>y(!x()),[T,H]=v(-1),V=()=>w()[T()],Q=s=>s===V(),L=s=>{z()||H(-1);const _=z()-1,ae=s==="next"?1:-1;let P=T()+ae;P>_&&(P=0),P<0&&(P=_),H(P)},X=()=>L("previous"),j=()=>L("next");$(O(w,s=>{x()&&H(Math.min(0,s.length-1))},{defer:!0})),$(O(()=>t.disabled,s=>{s&&x()&&y(!1)})),$(O(x,s=>{s?(T()===-1&&j(),E(!0)):(T()>-1&&H(-1),d(""))},{defer:!0})),$(O(T,s=>{s>-1&&!x()&&y(!0)},{defer:!0}));const Y=()=>E(!0),Z=()=>{E(!1),y(!1)},ee=s=>s.preventDefault(),te=s=>{!t.disabled&&!D()&&B()},ne=s=>{d(s.target.value)},re=s=>{switch(s.key){case"ArrowDown":j();break;case"ArrowUp":X();break;case"Enter":if(x()&&V()){S(V());break}return;case"Escape":if(x()){y(!1);break}return;case"Delete":case"Backspace":if(u())return;if(t.multiple){const _=i();c([..._.slice(0,-1)])}else p();break;case" ":if(u())return;x()?V()&&S(V()):y(!0);break;case"Tab":if(V()&&x()){S(V());break}return;default:return}s.preventDefault(),s.stopPropagation()};return{options:w,value:i,setValue:c,hasValue:l,clearValue:p,inputValue:u,setInputValue:d,hasInputValue:D,clearInputValue:f,isOpen:x,setIsOpen:y,toggleOpen:B,isActive:J,setIsActive:E,get multiple(){return t.multiple},get disabled(){return t.disabled},pickOption:S,isOptionFocused:Q,isOptionDisabled:t.isOptionDisabled,onFocusIn:Y,onFocusOut:Z,onMouseDown:ee,onClick:te,onInput:ne,onKeyDown:re}},we=g("<mark>"),I={NO_MATCH:0,MATCH:1,WORD_START:2,START:3},xe=(e,t)=>{let n=I.NO_MATCH,o=[];if(e.length<=t.length){const a=Array.from(e.toLocaleLowerCase()),i=Array.from(t.toLocaleLowerCase());let c=I.START;e:for(let p=0,l=0;p<a.length;p++){for(;l<i.length;)if(i[l]===a[p]){o[l]=!0,c===I.MATCH&&i[l-1]===" "&&i[l]!==" "&&(c=I.WORD_START),n+=c,c++,l++;continue e}else c=I.MATCH,l++;n=I.NO_MATCH,o.length=0}}return{target:t,score:n,matches:o}},ve=(e,t=n=>(()=>{const o=m(we);return M(o,n),o})())=>{const n=e.target,o=e.matches,a="\0",i=[];let c=!1;for(let p=0;p<n.length;p++){const l=n[p],u=o[p];!c&&u?(i.push(a),c=!0):c&&!u&&(i.push(a),c=!1),i.push(l)}return c&&(i.push(a),c=!1),R(()=>i.join("").split(a).map((p,l)=>l%2?t(p):p))},ke=(e,t,n)=>{const o=[];for(let a=0;a<t.length;a++){const i=t[a],c=n?i[n]:i,p=xe(e,c);p.score&&o.push({...p,item:i,index:a})}return o.sort((a,i)=>{let c=i.score-a.score;return c===0&&(c=a.index-i.index),c}),o},ye=g("<mark>"),C=(e,t)=>{const n=Object.assign({filterable:!0,disable:()=>!1},t||{}),o=l=>n?.key!==void 0?l[n.key]:l;return{options:l=>{let d=(typeof e=="function"?e(l):e).map(f=>({label:o(f),value:f,disabled:n.disable(f)}));if(n.filterable&&l&&(d=ke(l,d,"label").map(f=>({...f.item,label:ve(f)}))),n.createable!==void 0){const f=l.trim(),D=d.some(w=>$e(l,o(w.value)));if(f&&!D){let w;typeof n.createable=="function"?w=n.createable(f):w=n.key?{[n.key]:f}:f;const z={label:["Create ",(()=>{const S=m(ye);return M(S,()=>o(w)),S})()],value:w,disabled:!1};d=[...d,z]}}return d},optionToValue:l=>l.value,isOptionDisabled:l=>l.disabled,format:(l,u)=>u==="option"?l.label:o(l)}},$e=(e,t)=>e.localeCompare(t,void 0,{sensitivity:"base"})===0,Oe=(e,t=250)=>{const[n,o]=v(""),a=Ce(e,t),[i]=se(n,a,{initialValue:[]});return{get options(){return i()},get loading(){return i.loading},onInput:o,readonly:!1}},Ce=(e,t)=>{let n=null,o,a;const i=()=>new Promise(l=>o=setTimeout(l,t)),c=(...l)=>(a=l,n||(n=i().then(()=>(n=null,e(...a))),n)),p=()=>{clearTimeout(o),n=null};return ce()&&ue(p),Object.assign(c,{clear:p})},U=de(),A=()=>{const e=me(U);if(!e)throw new Error("No SelectContext found in ancestry.");return e},h=e=>{const[t,n]=pe(N({format:(a,i)=>a,placeholder:"Select...",readonly:typeof e.options!="function",loading:!1,loadingPlaceholder:"Loading...",emptyPlaceholder:"No options"},e),["options","optionToValue","isOptionDisabled","multiple","disabled","onInput","onChange"]),o=be(t);return $(O(()=>n.initialValue,a=>a!==void 0&&o.setValue(a))),r(U.Provider,{value:o,get children(){return r(Ve,{get class(){return n.class},get children(){return[r(De,{get id(){return n.id},get name(){return n.name},get format(){return n.format},get placeholder(){return n.placeholder},get autofocus(){return n.autofocus},get readonly(){return n.readonly}}),r(He,{get loading(){return n.loading},get loadingPlaceholder(){return n.loadingPlaceholder},get emptyPlaceholder(){return n.emptyPlaceholder},get format(){return n.format}})]}})}})},Se=k("div")`
    position: relative;
...
`,Ve=e=>{const t=A();return r(Se,{get class(){return`solid-select-container${e.class!==void 0?" "+e.class:""}`},get"data-disabled"(){return t.disabled},get onFocusIn(){return t.onFocusIn},get onFocusOut(){return t.onFocusOut},onMouseDown:n=>{t.onMouseDown(n),n.currentTarget.getElementsByTagName("input")[0].focus()},get children(){return e.children}})},_e=k("div")`
...
`,Me=e=>(A(),r(Pe,{class:"solid-select-multi-value",get children(){return[R(()=>e.children),r(Fe,{type:"button",class:"solid-select-multi-value-remove",onClick:t=>{t.stopPropagation(),e.onRemove()},children:"⨯"})]}})),Re=k("input")`
    grid-column-start: 1;
    grid-row-start: 1;
    flex: 1;
