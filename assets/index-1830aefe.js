import{s as a}from"./index-94caafb4.js";import{A as o}from"./Theme-c9d85115.js";import{R as A}from"./index-f7946e34.js";import{S as G}from"./UL-e6a4a899.js";import{c as r,m as u,k as p,g as k,j as W,r as q,t as y,u as N,l as b,o as ve,P as ke,S as c,i as v,d as te,n as ye,b as D,a as $e,f as V,e as Ce,p as De,q as m,F as re}from"./entry-client-3af6d313.js";import{T as F}from"./index-7355db2b.js";import{C as L}from"./index-f6f07d1f.js";import{I as Ve}from"./index-98966c2c.js";import{u as Be,v as Se}from"./index-bab6a310.js";import{I as Oe}from"./index-c5bef6b0.js";import{c as ne}from"./css-e90cefea.js";import{A as B}from"./index-760a4f67.js";const Pe=y("<div>"),Re=a("div")`
...
`;function oe(e,t){return t==null?e:typeof e>"u"?t()?"display:block;":"display:none;":typeof e=="string"?(t()?"display:block;":"display:none;")+e:{display:t()?"block":"none",...e}}function Me(e){return r(Re,u({get style(){return oe(e.style,e.isVisible)}},()=>p(e,["isVisible","style"])[1]))}function J(e){return e.currentTarget===e.target||!e.currentTarget.contains(e.target)}function ie(e){let t=!1;return{onMouseDown:n=>{t=J(n)},onMouseUp:n=>{const l=J(n);t&&l&&(n.stopImmediatePropagation(),e()),t=!1}}}function ze(e){const t=e.flex!=null?{display:"flex","flex-direction":e.flex,"justify-content":"center","align-items":"center"}:e.relative?{position:"relative"}:{};return(()=>{const n=k(Pe);return W(n,u(()=>ie(e.onClickOutside),{get children(){return e.children},get style(){return{width:"100%",height:"100%",...t}}}),!1,!1),q(),n})()}function le(e){return r(Me,u(()=>p(e,["children","onClickOutside","flex","relative"])[1],{get children(){return r(ze,{get children(){return e.children},get onClickOutside(){return e.onClickOutside},get flex(){return e.flex||(e.relative?void 0:"column")},get relative(){return e.relative}})}}))}const Ie=a("div")`
...
`,Ue=e=>{const t=u({multiple:!1,disabled:!1,optionToValue:i=>i,isOptionDisabled:i=>!1},e),n=i=>{if(t.multiple&&Array.isArray(i))return i;if(!t.multiple&&!Array.isArray(i))return i!==null?[i]:[];throw new Error(`Incompatible value type for ${t.multiple?"multple":"single"} select.`)},[l,d]=D(t.initialValue!==void 0?n(t.initialValue):[]),s=()=>t.multiple?l():l()[0]||null,$=i=>d(n(i)),M=()=>d([]),T=()=>!!(t.multiple?s().length:s());b(m(l,()=>t.onChange?.(s()),{defer:!0}));const[g,C]=D(""),se=()=>C(""),j=()=>!!g().length;b(m(g,i=>t.onInput?.(i),{defer:!0})),b(m(g,i=>{i&&!h()&&f(!0)},{defer:!0}));const z=typeof t.options=="function"?V(()=>t.options(g()),t.options(g())):()=>t.options,K=()=>z().length,I=i=>{if(t.isOptionDisabled(i))return;const w=t.optionToValue(i);t.multiple?$([...l(),w]):($(w),O(!1)),f(!1)},[ce,O]=D(!1),[h,f]=D(!1),U=()=>f(!h()),[P,E]=D(-1),x=()=>z()[P()],ue=i=>i===x(),Y=i=>{K()||E(-1);const w=K()-1,we=i==="next"?1:-1;let R=P()+we;R>w&&(R=0),R<0&&(R=w),E(R)},ge=()=>Y("previous"),Z=()=>Y("next");b(m(z,i=>{h()&&E(Math.min(0,i.length-1))},{defer:!0})),b(m(()=>t.disabled,i=>{i&&h()&&f(!1)})),b(m(h,i=>{i?(P()===-1&&Z(),O(!0)):(P()>-1&&E(-1),C(""))},{defer:!0})),b(m(P,i=>{i>-1&&!h()&&f(!0)},{defer:!0}));const he=()=>O(!0),be=()=>{O(!1),f(!1)},fe=i=>i.preventDefault(),me=i=>{!t.disabled&&!j()&&U()},pe=i=>{C(i.target.value)},xe=i=>{switch(i.key){case"ArrowDown":Z();break;case"ArrowUp":ge();break;case"Enter":if(h()&&x()){I(x());break}return;case"Escape":if(h()){f(!1);break}return;case"Delete":case"Backspace":if(g())return;if(t.multiple){const w=s();$([...w.slice(0,-1)])}else M();break;case" ":if(g())return;h()?x()&&I(x()):f(!0);break;case"Tab":if(x()&&h()){I(x());break}return;default:return}i.preventDefault(),i.stopPropagation()};return{options:z,value:s,setValue:$,hasValue:T,clearValue:M,inputValue:g,setInputValue:C,hasInputValue:j,clearInputValue:se,isOpen:h,setIsOpen:f,toggleOpen:U,isActive:ce,setIsActive:O,get multiple(){return t.multiple},get disabled(){return t.disabled},pickOption:I,isOptionFocused:ue,isOptionDisabled:t.isOptionDisabled,onFocusIn:he,onFocusOut:be,onMouseDown:fe,onClick:me,onInput:pe,onKeyDown:xe}},de=te(),S=()=>{const e=N(de);if(!e)throw new Error("No SelectContext found in ancestry.");return e},qt=e=>{const[t,n]=p(u({format:(d,s)=>d,placeholder:"Select...",readonly:typeof e.options!="function",loading:!1,loadingPlaceholder:"Loading...",emptyPlaceholder:"No options"},e),["options","optionToValue","isOptionDisabled","multiple","disabled","onInput","onChange"]),l=Ue(t);return b(m(()=>n.initialValue,d=>d!==void 0&&l.setValue(d))),r(de.Provider,{value:l,get children(){return r(Ze,{get class(){return n.class},get children(){return[r(Je,{get id(){return n.id},get name(){return n.name},get format(){return n.format},get placeholder(){return n.placeholder},get autofocus(){return n.autofocus},get readonly(){return n.readonly}}),r(dt,{get loading(){return n.loading},get loadingPlaceholder(){return n.loadingPlaceholder},get emptyPlaceholder(){return n.emptyPlaceholder},get format(){return n.format}})]}})}})},Ye=a("div")`
    position: relative;
    background-color : ${o.colors.bg200};
    border-radius : ${o.border.smRadius};
    max-width:25rem;
