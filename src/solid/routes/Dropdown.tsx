...
import {createAsyncOptions, createOptions, DropdownMenu} from "@qinetik/anique/dropdown";
...
const FormatExample = () => {
    ...
    return (
        <div class="flex flex-1 flex-col max-w-100 gap-3">
            <DropdownMenu options={options} format={format} onChange={setValue}/>
...
const MultipleExample = () => (
    <DropdownMenu multiple options={["apple", "banana", "pear", "pineapple", "kiwi"]} />
);

const MultipleFilterableExample = () => {
    const props = createOptions(["apple", "banana", "pear", "pineapple", "kiwi"]);
    return <DropdownMenu multiple {...props} />;
};
...
const AutoScrollExample = () => (
    <DropdownMenu options={[...Array(50).keys()]} />
);
